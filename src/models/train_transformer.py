...
OUTPUT_RESULTS_FILE = (
    ...
    / "data"
    / "processed"
    / "transformer_walk_forward_results.csv"
)
# ============================================================
# USTAWIENIA
# ============================================================
...
class TransformerClassifier(
    ...
    def __init__(
        ...
        # ----------------------------------------------------
        # Projekcja 11 cech wejściowych -> d_model
        # ----------------------------------------------------
    ...
    def forward(
        ...
        # ----------------------------------------------------
        # Late fusion:
        # Transformer + Ticker/SEC/FinBERT
        # ----------------------------------------------------
